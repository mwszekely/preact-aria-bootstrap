...
export declare function RichTextField({ implementation, toolbarItems, onValueChange, valueHtml, ...props }: RichTextFieldProps): import("preact").h.JSX.Element;
export declare function DocumentField({ implementation, toolbarItems, onValueChange, valueHtml, ...props }: RichTextFieldProps): import("preact").h.JSX.Element;

...
export declare const StructureRadioWrapper: ({ labelPosition, pending, inline, children, ...props }: StructureRadioWrapperProps, ref: Ref<HTMLSpanElement>) => import("preact").h.JSX.Element;

...
export declare const DataTable: ({ staggered, caption, captionPosition, bordered, header, dark, hover, striped, propsContainer, stripedColumns, variantBorder, variantSize, variantTheme, verticalAlign, children, paginationLabel, paginationLocation, paginationSize, ...props }: PaginatedProps<CaptionedProps<DataTableProps>>, ref?: Ref<HTMLTableElement>) => JSX.Element;
export declare const DataTableHeadRow: ({ row, children }: DataTableHeadRowProps, ref?: Ref<HTMLTableRowElement>) => JSX.Element;
export declare const DataTableBodyRow: ({ row, children, ...props }: DataTableBodyRowProps, ref?: Ref<HTMLTableRowElement>) => JSX.Element;
export declare const DataTableCell: ({ column, children, fillY, unsortable, variantTheme, colSpan, value, ...props }: DataTableCellProps, ref?: Ref<HTMLTableCellElement>) => JSX.Element;

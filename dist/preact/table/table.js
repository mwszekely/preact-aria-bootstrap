...
import { memo, useEnsureStability, useMergedProps } from "preact-prop-helpers";
import { forwardElementRef } from "../utility/forward-element-ref.js";
import { useClonedElement } from "../utility/use-cloned-element.js";
export const Table = /* @__PURE__ */ memo(forwardElementRef(function Table({ propsContainer, dark, hover, striped, stripedColumns, variantBorder, bordered, variantSize, variantTheme, verticalAlign, ...props }, ref) {
...
export const TableSection = /* @__PURE__ */ memo(forwardElementRef(function TableSection({ location, divider, variantTheme, ...props }, ref) {
...
export const TableRow = /* @__PURE__ */ memo(forwardElementRef(function TableRow({ variantTheme, children, ...props }, ref) {
...
export const TableCell = /* @__PURE__ */ memo(forwardElementRef(function TableCell({ variantTheme, fillY, tableHeadType, children, ...props }, ref) {

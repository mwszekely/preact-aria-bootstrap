...
export declare const GridBsContainer: ({ fillUntil, children, ...props }: GridBsContainerProps, ref?: Ref<HTMLDivElement>) => import("preact").VNode<any>;
export declare const GridBsRow: ({ justify, children, gutterHorizontal, gutterHorizontalXs, gutterHorizontalSm, gutterHorizontalMd, gutterHorizontalLg, gutterHorizontalXl, gutterHorizontalXxl, gutterVertical, gutterVerticalXs, gutterVerticalSm, gutterVerticalMd, gutterVerticalLg, gutterVerticalXl, gutterVerticalXxl, gutter, gutterXs, gutterSm, gutterMd, gutterLg, gutterXl, gutterXxl, ...props }: GridBsRowProps, ref: Ref<HTMLDivElement>) => import("preact").VNode<any>;
export declare const GridBsItem: ({ children, offset, offsetXs, offsetSm, offsetMd, offsetLg, offsetXl, offsetXxl, span, spanXs, spanSm, spanMd, spanLg, spanXl, spanXxl, ...props }: GridBsItemProps, ref: Ref<HTMLDivElement>) => import("preact").VNode<any>;
export declare const GridBsBreak: ({ hideUntil, children, ...props }: GridBsBreakProps, ref: Ref<HTMLDivElement>) => import("preact").VNode<any>;

...
export declare const StructureCheckboxInput: ({ ...props }: StructureCheckboxInputProps, ref: Ref<HTMLInputElement>) => any;
export interface StructureCheckboxLabelProps extends GlobalAttributes<HTMLLabelElement, "children"> {
}
export declare const StructureCheckboxLabel: ({ children, ...props }: StructureCheckboxLabelProps, ref: Ref<HTMLLabelElement>) => any;

...
export declare const Accordion: ({ children, ...props }: AccordionProps, ref: Ref<HTMLDivElement>) => any;
export declare const AccordionSection: ({ index, children, header, bodyRole, disabled, untabbable, open, ...props }: AccordionSectionProps, ref: Ref<HTMLDivElement>) => any;

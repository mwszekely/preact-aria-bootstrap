...
import { ComponentChildren, JSX, Nullable, Ref, VNode } from "preact-prop-helpers";
...
export declare const Dialog: ({ open, fullscreen, variantSize, header, headerPosition, footer, onClose, anchor, modal, children, propsPortal, ...props }: DialogProps, ref?: Ref<HTMLSpanElement>) => any;

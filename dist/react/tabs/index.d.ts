...
export declare const Tabs: ({ keyboardControlsDescription, orientation, label, localStorageKey, labelPosition, panels, tabs, propsPanelsContainer, propsTabsContainer, ...props }: LabelledProps<TabsProps, never>, ref: Ref<HTMLDivElement>) => any;
export declare const Tab: ({ index, children, ...props }: TabProps, ref: Ref<HTMLLIElement>) => any;
export declare const TabPanel: ({ index, ...props }: TabPanelProps, ref: Ref<HTMLDivElement>) => any;

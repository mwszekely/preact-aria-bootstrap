...
export declare const StructureTabPanel: ({ orientation, visibleOffset, visible, children, ...props }: StructureTabPanelProps, ref: Ref<HTMLDivElement>) => any;
...
export declare const StructureTabs: ({ orientation, children, ...props }: StructureTabsProps, ref: Ref<HTMLDivElement>) => any;
export declare const StructureTabPanelsContainer: ({ orientation, children: panels, ...props }: StructureTabPanelsContainerProps, ref: Ref<HTMLDivElement>) => any;
export declare const StructureTabList: ({ orientation, typeaheadStatus, labelPosition, childrenLabel: labelJsx, children: tabs, keyboardControlsDescription, ...props }: StructureTabListProps, ref: Ref<HTMLUListElement>) => any;

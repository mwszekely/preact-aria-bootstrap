...
export declare const GridCss: ({ columns, gap, children, ...props }: GridCssProps, ref: Ref<HTMLDivElement>) => import("preact").VNode<import("preact").DOMAttributes<HTMLInputElement> & import("preact").ClassAttributes<HTMLInputElement>>;
export declare const GridCssItem: ({ span, spanXs, spanSm, spanMd, spanLg, spanXl, spanXxl, start, startXs, startSm, startMd, startLg, startXl, startXxl, children, ...props }: GridCssItemProps, ref?: Ref<HTMLDivElement>) => import("preact").VNode<import("preact").DOMAttributes<HTMLInputElement> & import("preact").ClassAttributes<HTMLInputElement>>;

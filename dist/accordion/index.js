...
export const AccordionSection = memo(forwardElementRef(function AccordionSection({ index, children, header, bodyRole, disabled, hidden, open, ...props }, ref) {
    return (_jsx(AriaAccordionSection, { index: index, tagButton: "button", bodyRole: bodyRole, disabled: disabled, hidden: hidden, open: open, render: info => {
